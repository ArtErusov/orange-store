...
const saveSortHandler = (index) =>{ props.onSaveSort(index) };   //передача на верх из CardSort 
  ...
  return (<div>
      ...
      <Cards searchValue={props.searchValue} onSaveCategory={saveCategoryHandler} onSaveSort={saveSortHandler} isLoading={props.isLoading} cardFiling={props.cardFiling} selectCategory={props.selectCategory} />
   </div>
  );
}
